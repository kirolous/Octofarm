		...
		function showTable(response) 
		{
			...
			for(i=0; i<time.files.length; i++){
				...
				if(time.files[i].gcodeAnalysis.estimatedPrintTime){					 
					...
					textnode7=document.createTextNode(hours +"H:"+min+"M:"+sec.toFixed(0)+"S");	// Print out the hours mins and sec with the format hours:min:Seconds
				}else{
